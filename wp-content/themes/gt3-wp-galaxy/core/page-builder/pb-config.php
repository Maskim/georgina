...
#gt3_update_theme_option("dev_console", "true");
#gt3_delete_theme_option("dev_console");
...
#$gt3_pbconfig['page_bg_available_types'] = array('stretched', 'center', 'repeat');
$gt3_pbconfig['page_bg_available_types'] = array('stretched', 'repeat');
...
#all_available_headers_for_module
$gt3_pbconfig['all_available_headers_alignment'] = array("left", "center");

#default heading in module
$gt3_pbconfig['default_heading_in_module'] = "h4";

#available quote types
$gt3_pbconfig['all_available_quote_types'] = array("" => "Dark", "type1" => "Light", "type2" => "Colored");
...
$gt3_pbconfig['all_available_custom_buttons'] = array(
    ...
    "btn_small btn_type14" => "Small Green",
    "btn_small btn_type15" => "Small Sea Green",
    ...
    "btn_normal btn_type14" => "Medium Green",
    "btn_normal btn_type15" => "Medium Sea Green",
    ...
    "btn_large btn_type14" => "Large Green",
    "btn_large btn_type15" => "Large Sea Green"
);
...
$gt3_pbconfig['available_tabs_types'] = array(
    "type1" => "Horizontal",
    "type2" => "Vertical 1",
    "type3" => "Vertical 2"
);
...
$gt3_pbconfig['available_padding_top_for_bg_start'] = array(
...
$gt3_pbconfig['gallery_images_in_a_row'] = array(
    "2" => "2",
    "3" => "3",
    "4" => "4"
);
