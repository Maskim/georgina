...
function gt3_the_select_options($option_array, $selected_value = "")
{
...
function gt3_get_select_options($option_array, $selected_value = "")
{
    if (!isset($compile)) {
        $compile = '';
    }
...
function gt3_get_select_options_with_caption($option_array, $selected_value = "")
{
    if (!isset($compile)) {
        $compile = '';
    }
...
function gt3_get_media_for_this_post($postid, $page = "1")
{
    global $gt3_pbconfig;
    $args = array(
...
function gt3_get_selected_pf_images_for_admin($gt3_pagebuilder)
{
    if (!isset($compile)) {
        $compile = '';
    }
    if (isset($gt3_pagebuilder['post-formats']['images']) && is_array($gt3_pagebuilder['post-formats']['images'])) {
        foreach ($gt3_pagebuilder['post-formats']['images'] as $imgid => $img) {
            $compile .= "<div class='img-item style_small'><div class='img-preview'><img src='" . aq_resize($img['src'], "62", "62", true) . "' data-full-url='{$img['src']}' data-thumb-url='" . aq_resize($img['src'], "156", "106", true) . "' alt='' class='previmg'><div class='hover-container'></div><div class='deldel-container'></div></div><input type='hidden' name='pagebuilder[post-formats][images][" . $imgid . "][src]' value='{$img['src']}'></div>";
        }
    }
    return $compile;
}
...
function gt3_get_selected_pf_images($gt3_pagebuilder)
{
    if (is_array($gt3_pagebuilder['post-formats']['images'])) {
        if (!isset($compile)) {
            $compile = '';
        }
        if (count($gt3_pagebuilder['post-formats']['images']) == 1) {
            ...
            if ($style == "small") {
                ...
                <div class='img-item style_small available_media_item'>
                    <div class='img-preview'>
                        <img class='previmg' alt='' data-thumb-url='" . aq_resize($media_url, "156", "106", true) . "' data-full-url='" . $media_url . "' src='" . aq_resize($media_url, "62", "62", true) . "'>
                            ...
                            <div class='this-option img-in-slider'>
                                <div class='padding-cont'>
                                    ...
                                    <div class='right_block fl w1'>
                                        <h4>color</h4>
                                        " . gt3_colorpicker_block("pagebuilder[sliders][fullscreen][slides][{$key}][title][color]", $slide['title']['color']) . "
                                    </div>
                                    <div class='clear'></div>
                                </div>
                                ...
                                <div class='padding-cont'>
                                    ...
                                    <div class='right_block fl w1'>
                                        <h4>color</h4>
                                        " . gt3_colorpicker_block("pagebuilder[sliders][fullscreen][slides][{$key}][caption][color]", $slide['caption']['color']) . "
                                    </div>
                                    <div class='clear'></div>
                                </div>
                            </div>
                        ...
                        <div class='edit_popup'>
                            ...
                            <div class='this-option img-in-slider'>
                                <div class='padding-cont'>
                                    ...
                                    <div class='right_block fl w1'>
                                        <h4>color</h4>
                                        " . gt3_colorpicker_block("pagebuilder[sliders][fullwidth][slides][{$key}][title][color]", $slide['title']['color']) . "
                                    </div>
                                    <div class='clear'></div>
                                </div>
                                <div class='hr_double'></div>
                                <div class='padding-cont'>
                                    ...
                                    <div class='right_block fl w1'>
                                        <h4>color</h4>
                                        " . gt3_colorpicker_block("pagebuilder[sliders][fullwidth][slides][{$key}][caption][color]", $slide['caption']['color']) . "
                                    </div>
                                    <div class='clear'></div>
                                </div>
                            </div>
...
function gt3_colorpicker_block($name, $value, $additional_class = "")
{
    return "
...
function gt3_toggle_radio_yes_no($settingsname, $settingstate, $default_state = "yes", $additional_class = "")
{
...
function gt3_pb_setting_input($settingsname, $settingstate, $default_state = "yes", $additional_class = "")
{
    if ($settingstate == "") {
...
function gt3_toggle_radio_on_off($settingsname, $settingstate, $default_state = "on", $additional_class = "")
{
...
function gt3_get_html_all_available_pb_modules($modules)
{
    if (!isset($compile)) {
        $compile = "";
    }
...
function gt3_get_def_bg_pos_admin_options_style()
{
    global $gt3_pbconfig;
...
function gt3_get_theme_pagebuilder($postid)
{
    ...
    if (!isset($gt3_pagebuilder['settings']['show_content_area'])) {
        $gt3_pagebuilder['settings']['show_content_area'] = "yes";
    }
    if (!isset($gt3_pagebuilder['settings']['show_page_title'])) {
        $gt3_pagebuilder['settings']['show_page_title'] = "yes";
    }
    if (!isset($gt3_pagebuilder['settings']['layout-sidebars'])) {
        $gt3_pagebuilder['settings']['layout-sidebars'] = gt3_get_theme_option("default_sidebar_layout");
    }
    if (!isset($gt3_pagebuilder['settings']['show_breadcrumb'])) {
        $gt3_pagebuilder['settings']['show_breadcrumb'] = gt3_get_theme_option("default_breadcrumb_status");
    }
...
function gt3_update_theme_pagebuilder($post_id, $variableName, $gt3_pagebuilderArray)
{
...
function gt3_get_default_sidebars()
{
    $sidebars['layout-sidebars'] = gt3_get_theme_option("default_sidebar_layout");
...
function gt3_get_default_pb_settings()
{
    ...
    $gt3_pagebuilder['settings']['bg_image']['status'] = gt3_get_theme_option("show_bg_img_by_default");
    $gt3_pagebuilder['settings']['bg_image']['src'] = gt3_get_theme_option("bg_img");
    $gt3_pagebuilder['settings']['custom_color']['status'] = gt3_get_theme_option("show_bg_color_by_default");
    $gt3_pagebuilder['settings']['custom_color']['value'] = gt3_get_theme_option("default_bg_color");
    $gt3_pagebuilder['settings']['bg_image']['type'] = gt3_get_theme_option("default_bg_img_position");
...
function gt3_get_shortcodes_selector($class)
{
...
function gt3_the_pb_custom_bg_and_color($gt3_pagebuilder)
{
    $gt3_cover = '';
    $gt3_bgcolor = '';
    $gt3_bgimg = '';
    ...
    $fullimg = '';
    $classimg = '';
    if (!isset($gt3_pagebuilder['settings']['layouts']['type'])) {
        $gt3_pagebuilder['settings']['layouts']['type'] = "default";
    }
    if ($gt3_pagebuilder['settings']['layouts']['type'] == "default") {
        $page_layout = gt3_get_theme_option("default_theme_layout");
    } else {
        $page_layout = $gt3_pagebuilder['settings']['layouts']['type'];
    }
    ...
    switch ($page_layout) {
        ...
        case "clean":
            if (isset($gt3_pagebuilder['settings']['bg_image']['status']) && $gt3_pagebuilder['settings']['bg_image']['status'] == "on") {
                $gt3_bgimg = $gt3_pagebuilder['settings']['bg_image']['src'];
            } else {
                $gt3_bgimg = gt3_get_theme_option("bg_pattern");
            }
            if (isset($gt3_pagebuilder['settings']['custom_color']['status']) && $gt3_pagebuilder['settings']['custom_color']['status'] == "on") {
                $gt3_bgcolor = $gt3_pagebuilder['settings']['custom_color']['value'];
            } else {
                $gt3_bgcolor = gt3_get_theme_option("default_bg_color");
            }
            #echo '<div class="layout_trigger clean_bg_cont" style="background-image:url('.$gt3_bgimg.'); background-repeat: repeat; background-color:#'.$gt3_bgcolor.';"></div>';
        ...
        case "boxed":
            ...
            echo '<div class="layout_trigger boxed_bg_cont" style="background-image:url(' . $gt3_bgimg . '); background-repeat: repeat; background-color:#' . $gt3_bgcolor . ';"></div>';
            break;
        ...
        case "fullscreen_bg_image":
            if (isset($gt3_pagebuilder['settings']['bg_image']['status']) && $gt3_pagebuilder['settings']['bg_image']['status'] == "on") {
                ...
                $gt3_bgimg = gt3_get_theme_option("bg_img");
            }
            if (isset($gt3_pagebuilder['settings']['custom_color']['status']) && $gt3_pagebuilder['settings']['custom_color']['status'] == "on") {
                $gt3_bgcolor = $gt3_pagebuilder['settings']['custom_color']['value'];
            } else {
            ...
            echo '<div data-addon_pattern="' . gt3_get_theme_option("bg_pattern") . '" data-addon_color="' . $gt3_bgcolor . '" class="layout_trigger image_bg_cont" style="background-image:url(' . $gt3_bgimg . '); background-repeat: no-repeat; background-color:#' . $gt3_bgcolor . ';"></div>';
            break;
    }
}
