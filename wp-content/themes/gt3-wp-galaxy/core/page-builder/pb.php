...
#get all sidebars
    ...
    $media_for_this_post = gt3_get_media_for_this_post(get_the_ID());
    $js_for_pb = "
    <script>
        ...
        <div class='hideable-content'>
            <div class='padding-cont'>
                <div class='available-modules-cont'>
                    ...
                    " . gt3_get_html_all_available_pb_modules($modules) . "
                </div>
                <div class='clear'></div>
            </div>
...
<div class='pb-cont page-settings-container'>
    ...
    <div class='pb10'>
        <div class='hideable-content'>
            ...
            <div class='post-formats-container'>
                ...
                <div id='portslides_sectionid_inner'>
                    ...
                    <div class='selected-images-for-pf'>
                        " . gt3_get_selected_pf_images_for_admin($gt3_pagebuilder) . "
                    </div>
            ...
            <div class='padding-cont'>
                <div class='select-layout-container'>
                    ...
                    <input type='hidden' class='default_sidebar_layout' name='default_sidebar_layout' value='" . gt3_get_theme_option("default_sidebar_layout") . "'>
                </div>
                <div class='clear'></div>
        ...
        gt3_the_select_options($all_sidebars, $gt3_pagebuilder['settings']['left-sidebar']);
        echo "  </select>
                </div>
        ...
        gt3_the_select_options($all_sidebars, $gt3_pagebuilder['settings']['right-sidebar']);
        echo "  </select>
                </div>
                <div class='clear'></div>
            </div>
            ...
            <div class='padding-cont'>
                <div class='radio_block'>
                    ...
                    <div class='radio_selector'>
                        " . gt3_toggle_radio_yes_no('pagebuilder[settings][show_page_title]', $gt3_pagebuilder['settings']['show_page_title'], 'yes') . "
                    </div>
                ...
                <!--div class='radio_block' style='padding-top:15px;'>
                    ...
                    <div class='radio_selector'>
                        " . gt3_toggle_radio_yes_no('pagebuilder[settings][show_content_area]', $gt3_pagebuilder['settings']['show_content_area'], 'yes') . "
                    </div>
                    <div class='help_here text-shadow1'></div>
                    <div class='clear'></div>
                </div-->
                <div class='radio_block' style='padding-top:15px;'>
                    ...
                    <div class='radio_selector'>
                        " . gt3_toggle_radio_yes_no('pagebuilder[settings][show_breadcrumb]', $gt3_pagebuilder['settings']['show_breadcrumb'], 'yes') . "
                    </div>
                    <div class='help_here text-shadow1'></div>
                    <div class='clear'></div>
                </div>";
        ...
        if ($now_post_type == "port") {
                ...
                <div class='text_block' style='padding-top:15px;'>
                    ...
                    " . gt3_pb_setting_input('pagebuilder[settings][external_link]', (isset($gt3_pagebuilder['settings']['external_link']) ? $gt3_pagebuilder['settings']['external_link'] : ''), '') . "
                    <div class='help_here text-shadow1'></div>
                    <div class='clear'></div>
                </div>
                ";
                ...
                <div class='text_block' style='padding-top:15px;'>
                    ...
                    " . gt3_pb_setting_input('pagebuilder[settings][time_spent]', (isset($gt3_pagebuilder['settings']['time_spent']) ? $gt3_pagebuilder['settings']['time_spent'] : ''), '') . "
                    <div class='help_here text-shadow1'></div>
                    <div class='clear'></div>
                </div>
                ";
                ...
                <div class='text_block' style='padding-top:15px;'>
                    ...
                    " . gt3_pb_setting_input('pagebuilder[settings][skills_needed]', (isset($gt3_pagebuilder['settings']['skills_needed']) ? $gt3_pagebuilder['settings']['skills_needed'] : ''), '') . "
                    <div class='help_here text-shadow1'></div>
                    <div class='clear'></div>
                </div>
                ";
...
<div class='pb-cont hided-state sliders-and-bgs-container'>
            ...
            <div class='padding-cont  stand-s pt_" . $now_post_type . "' style='padding-top:20px;padding-bottom:0px;'>
                <div class='bg_or_slider_option slider_type active'>
                    ...
                    <div class='heading line_option visual_style1'>
                        ...
                        <div class='toggler'>" . gt3_toggle_radio_on_off('pagebuilder[sliders][fullscreen][status]', (isset($gt3_pagebuilder['sliders']['fullscreen']['status']) ? $gt3_pagebuilder['sliders']['fullscreen']['status'] : ''), 'off', 'fullscreen_toggler bg_slide_sett') . "</div>
                    ...
                    <div class='hideable-area'>
                            ...
                            <div class='selected_media'>
                                <div class='append_block'>
                                     <ul class='sortable-img-items'>
                                       " . gt3_get_slider_items("fullscreen", (isset($gt3_pagebuilder['sliders']['fullscreen']['slides']) ? $gt3_pagebuilder['sliders']['fullscreen']['slides'] : '')) . "
                                     </ul>
                                </div>
                                <div class='clear'></div>
                            </div>
                        ...
                        <div class='padding-cont'>
                            <div class='radio_block'>
                                ...
                                <div class='radio_selector'>
                                    " . gt3_toggle_radio_on_off('pagebuilder[sliders][fullscreen][thumbnails]', (isset($gt3_pagebuilder['sliders']['fullscreen']['thumbnails']) ? $gt3_pagebuilder['sliders']['fullscreen']['thumbnails'] : ''), 'on') . "
                                </div>
            ...
            <div class='padding-cont  stand-s pt_" . $now_post_type . "' style='padding-top:20px;padding-bottom:0px;'>
                <div class='bg_or_slider_option slider_type active'>
                    ...
                    <div class='heading line_option visual_style1'>
                        ...
                        <div class='toggler'>" . gt3_toggle_radio_on_off('pagebuilder[sliders][fullwidth][status]', $gt3_pagebuilder['sliders']['fullwidth']['status'], 'off', 'fullwidth_toggler bg_slide_sett') . "</div>
                        <div class='pre_toggler'></div>
                    </div>
                    <div class='hideable-area'>
                        ...
                        <div class='padding-cont' style='padding-bottom:11px;'>
                            <div class='selected_media'>
                                <div class='append_block'>
                                     <ul class='sortable-img-items'>
                                       " . gt3_get_slider_items("fullwidth", $gt3_pagebuilder['sliders']['fullwidth']['slides']) . "
                                     </ul>
                                </div>
                                <div class='clear'></div>
                            </div>
    ...
    if ($gt3_pbconfig['enable_background_image'] == true && in_array($now_post_type, $gt3_pbconfig['bg_image_enabled_for'])) {
        ...
        if (gt3_get_theme_option("show_bg_img_by_default") == "yes") {
        ...
        if (gt3_get_theme_option("show_bg_img_by_default") == "on") {
        ...
        echo gt3_get_select_options_with_caption(array("default"=>"Default", "clean"=>"Clean", "boxed"=>"Boxed", "fullscreen_bg_image"=>"Fullscreen bg image"), $gt3_pagebuilder['settings']['layouts']['type']);
        echo "
        </select>
        </div>
        <!-- END LAYOUT SETTINGS -->
            ...
            <div class='padding-cont  stand-s' style='padding-top:20px;padding-bottom:0px;'>
                <div class='bg_or_slider_option bg_type active'>
                    ...
                    <div class='heading line_option visual_style1'>
                        ...
                        <div class='toggler'>" . gt3_toggle_radio_on_off('pagebuilder[settings][bg_image][status]', (isset($gt3_pagebuilder['settings']['bg_image']['status']) ? $gt3_pagebuilder['settings']['bg_image']['status'] : ''), $bg_img_open_state, 'bgimage_toggler bg_slide_sett') . "</div>
                        <div class='pre_toggler'></div>
                    </div>
                    <div class='hideable-area'>
                        <div class='padding-cont' style='padding-bottom:11px;'>
                            <div class='bg_for_this_page w2 fl'>
                                <div class='img-item'>
                                    ...
                                    <div class='img-preview'>
                                        <img class='preview_bg_image' src='" . aq_resize($gt3_pagebuilder['settings']['bg_image']['src'], "156", "106", true) ."' alt=''>
                                    </div>
                                </div>
                            </div>";
        ...
        gt3_the_select_options($gt3_pbconfig['page_bg_available_types'], $gt3_pagebuilder['settings']['bg_image']['type']);
        echo "  </select>
                                <div class='help'>
    ...
    if ($gt3_pbconfig['enable_background_color'] == true && in_array($now_post_type, $gt3_pbconfig['bg_color_enabled_for'])) {
        ...
        if (gt3_get_theme_option("show_bg_color_by_default") == "on") {
            ...
            <div class='padding-cont stand-s' style='padding-top:20px;'>
                <div class='bg_or_slider_option custom_color_type active'>
                    ...
                    <div class='heading line_option visual_style1'>
                        ...
                        <div class='toggler'>" . gt3_toggle_radio_on_off('pagebuilder[settings][custom_color][status]', (isset($gt3_pagebuilder['settings']['custom_color']['status']) ? $gt3_pagebuilder['settings']['custom_color']['status'] : ''), $show_color_by_default, 'bgcolor_toggler bg_slide_sett') . "</div>
                        <div class='pre_toggler'></div>
                    </div>
                    <div class='hideable-area'>
                        <div class='padding-cont' style='padding-bottom:20px;'>
                            ...
                            <div class='left_block'>
                                " . gt3_colorpicker_block("pagebuilder[settings][custom_color][value]", (isset($gt3_pagebuilder['settings']['custom_color']['value']) ? $gt3_pagebuilder['settings']['custom_color']['value'] : ''), "background_color") . "
                            </div>
...
<?php
#DEVELOPER CONSOLE
    if ($gt3_pbconfig['dev_console'] == true || gt3_get_theme_option("dev_console") == "true") {
...
function save_postdata($post_id)
{
    ...
    if (isset($_POST['pagebuilder'])) {
        gt3_update_theme_pagebuilder($post_id, "pagebuilder", $_POST['pagebuilder']);
    }
}
