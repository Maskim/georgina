...
{
    global $gt3_lineWidth;
    #if (!isset($gt3_lineWidth)) {$gt3_lineWidth = 0;}
    if (!is_array($modules)) {
        $modules = array();
    }
    ...
    foreach ($modules as $module_key => $module) {
        ...
        if ($module['name'] == "bg_start" || $module['name'] == "bg_end") {
            ...
            echo "<div class='{$outputClass} " . (($normalModulesICounter == 1) ? "first-module" : "") . " module_number_{$normalModulesICounter} module_cont " . ((isset($module['heading_alignment']) && $module['heading_alignment'] == "center") ? 'center_title' : '') . " {$module['padding_bottom']} module_{$module['name']}'>";
            ...
            switch ($module['name']) {
                ...
                case "content":
                    ...
                    echo the_content(((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("read_more_link") : __('Read more!', 'theme_localization')));
                    echo "</div>";
                ...
                case "messageboxes":
                    ...
                    echo do_shortcode("[gt3_messagebox
                    heading_color='" . $module["heading_color"] . "'
                    heading_size='" . $module["heading_size"] . "'
                    heading_text=\"" . $module["heading_text"] . "\"
                    messagebox_heading='" . $module["messagebox_heading"] . "'
                    box_type='" . $module["box_type"] . "'
                    ]" . $module["messagebox_text"] . "[/gt3_messagebox]");
                    break;
                #BREAK
