...
if (is_array($gt3_pbconfig['all_available_social_icons_type'])) {
    foreach ($gt3_pbconfig['all_available_social_icons_type'] as $social_type_value => $social_type_Caption) {
        $gt3_compileShortcodeUI .= "<option value='".$social_type_value."'>".$social_type_Caption."</option>";
    }
}
$gt3_compileShortcodeUI .= "</select></td>
	</tr>
	<tr>
		<td>Style:</td>
...
if (is_array($gt3_pbconfig['all_available_social_icons'])) {
    foreach ($gt3_pbconfig['all_available_social_icons'] as $social_iconclass => $social_iconCaption) {
        $gt3_compileShortcodeUI .= "<option value='".$social_iconclass."'>".$social_iconCaption."</option>";
    }
}
$gt3_compileShortcodeUI .= "</select></td>
	</tr>
...
$gt3_shortcodesUI['shortcode_social_icon'] = array("name" => $shortcodeName, "handler" => $gt3_compileShortcodeUI);
