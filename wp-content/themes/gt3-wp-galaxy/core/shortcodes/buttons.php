...
if (is_array($gt3_pbconfig['all_available_custom_buttons'])) {
    foreach ($gt3_pbconfig['all_available_custom_buttons'] as $buttonclass => $buttonCaption) {
        $gt3_compileShortcodeUI .= "<option value='".$buttonclass."'>".$buttonCaption."</option>";
    }
}
...
$gt3_shortcodesUI['shortcode_button'] = array("name" => $shortcodeName, "handler" => $gt3_compileShortcodeUI);
