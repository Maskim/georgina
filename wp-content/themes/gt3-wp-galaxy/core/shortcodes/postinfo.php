            ...
            if ($show_share_buttons == "yes") {
                $compile .= '
                    <div class="portfolio_share">
                        ...
                        <a href="http://pinterest.com/pin/create/button/?url='.get_permalink().'&media='.gt3_get_theme_option("logo").'" class="ico_socialize_pinterest ico_socialize type2"></a>
...
#$gt3_shortcodesUI['postinfo'] = array("name" => $shortcodeName, "handler" => $gt3_compileShortcodeUI);
