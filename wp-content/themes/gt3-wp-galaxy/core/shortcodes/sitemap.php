...
$compile .= '
    <div class="span4">';
        ...
        if ($show_site_feeds == "yes") {
            $compile .= '
            <div class="bg_title"><h4 class="sitemap_block_title">'.((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("translator_site_feeds") : __('Site Feeds','theme_localization')).'</h4></div>
            <ul class="sitemap_list">
                <li><a href="'.get_bloginfo('rss_url').'">'.((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("translator_main_rss_feed") : __('Main RSS Feed','theme_localization')).'</a></li>
                <li><a href="'.get_bloginfo('comments_rss2_url').'">'.((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("translator_comment_rss_feed") : __('Comments RSS Feed','theme_localization')).'</a></li>
            </ul>
        ...
        /* PAGES */
        $compile .= '<div class="bg_title"><h4 class="sitemap_block_title">'.((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("translator_pages") : __('Pages','theme_localization')).'</h4></div>';
        $args = array(
            'depth'        => 2,
...
$compile .= '
    ...
    <div class="span4">';
        /* PORTFOLIO */
        $compile .= '<div class="bg_title"><h4 class="sitemap_block_title">'.((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("translator_portfolio") : __('Portfolio','theme_localization')).'</h4></div>';
        $args = array(
            'depth'        => 2,
            'sort_column'  => 'menu_order, post_title',
            'post_type'    => 'port',
    ...
    $compile .= '
    <div class="span4">
        <div class="bg_title"><h4 class="sitemap_block_title">'.((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("translator_posts") : __('Posts','theme_localization')).'</h4></div>
        ...
        $gt3_wp_query_in_shortcodes->query($args);
            ...
            while ($gt3_wp_query_in_shortcodes->have_posts()) : $gt3_wp_query_in_shortcodes->the_post();
                ...
                <li>
                    ...
                    <span class="sitemap_comments"><a href="'.get_comments_link().'">'.((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("comments_number") : __('Comments','theme_localization')).": "
...
#$gt3_shortcodesUI['sitemap'] = array("name" => $shortcodeName, "handler" => $gt3_compileShortcodeUI);
