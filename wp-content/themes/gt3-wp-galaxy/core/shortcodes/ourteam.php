					...
					<li>
                        <div class="item">
							...
							if (has_post_thumbnail()) {
								$compile .= '<img src="'.aq_resize($featured_image[0], "840", "622", true).'" alt="'.get_the_title().'" />';
							} else {
								$compile .= '<img src="'.aq_resize(IMGURL.'/core/team-unknown.jpg', "840", "622", true).'" alt="'.get_the_title().'" />';
							}
			   ...
			   $compile .= '
			                ...
			                <div class="carousel_body">
                                <div class="carousel_title">
                                    <h5>'.get_the_title().'</h5>
                                    <h6 class="op">'.get_post_meta(get_the_ID(), "teams_position", true).'</h6>
                                </div>
...
#$gt3_shortcodesUI['ourteam'] = array("name" => $shortcodeName, "handler" => $gt3_compileShortcodeUI);
