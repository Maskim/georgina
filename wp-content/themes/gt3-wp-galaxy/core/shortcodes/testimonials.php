                            ...
                            <li>
                                <div class='item'>
                                    <div class='testimonials_photo'>
                                            ".(strlen($featured_image[0])>0 ? "<img src='".aq_resize($featured_image[0], "172", "172", true)."' class='testimonials_ava'>" : "<img src='".IMGURL."/core/testimonials.jpg'  class='testimonials_ava'>")."
                                    </div>
...
#$gt3_shortcodesUI['testimonials'] = array("name" => $shortcodeName, "handler" => $gt3_compileShortcodeUI);
