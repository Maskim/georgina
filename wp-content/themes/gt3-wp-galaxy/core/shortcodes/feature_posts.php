    ...
    public function register_shortcode($shortcodeName)
    {
        function shortcode_feature_posts($atts, $content = null)
        {
            ...
            if (strlen($heading_text) > 0) {
                $compile = "<div class='bg_title'><a href='".esc_js("javascript:void(0)")."' class='btn_carousel_left'></a><" . $heading_size . " style='" . (isset($custom_color) ? $custom_color : '') . "' class='headInModule'>{$heading_text}</" . $heading_size . "><a href='".esc_js("javascript:void(0)")."' class='btn_carousel_right'></a></div>";
            }
        ...
        ';
            ...
            if ($related == "yes") {
                ...
                if ($post_type == "port") {
                    ...
                    while ($wp_query->have_posts()) : $wp_query->the_post();
                        ...
                        if (strlen($featured_image[0]) > 0) {
                            ...
                            $full_image_url = aq_resize(IMGURL . '/core/featured_image2.jpg', "270", "163", true);
                        }
                        ...
                        $compile .= '
                            <li>
                                <div class="item">
                                    ...
                                    <div class="img_block wrapped_img"><img src="'.$featured_image_url.'" alt="" width="270" height="170"><div class="carousel_fadder"></div></div>
                                    <div class="carousel_body">
                                        <div class="carousel_title">
                                            <h5><a href="' . get_permalink(get_the_ID()) . '">'.get_the_title().'</a></h5>
                                        </div>
                                        <div class="carousel_desc">
                                            <div class="exc">' . gt3_smarty_modifier_truncate(get_the_excerpt(), 115) . '</div>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                if ($post_type == "post") {
                    ...
                    if (is_array($recent_posts)) {
                        foreach ($recent_posts as $recent) {
                            ...
                            $post_excerpt = ((strlen($recent->post_excerpt)>0) ? $recent->post_excerpt : gt3_smarty_modifier_truncate($recent->post_content, 110));
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="carousel_body">
                                        <div class="carousel_title">
                                            <a href="' . get_permalink($recent->ID) . '"><h5>' . $recent->post_title . '</h5></a>
                                        </div>
                                        <div class="carousel_desc">
                                            <div class="exc">
                                                ' . $post_excerpt . '
                                            <!--a href="' . get_permalink($recent->ID) . '">'.((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("read_more_link") : __('Read more!','theme_localization')).'</a-->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                $args = array('numberposts' => $number_of_posts, 'post_type' => $post_type, 'post_status' => 'publish', 'orderby' => $sort_type, 'order' => 'DESC', 'suppress_filters' => false);
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="carousel_body">
                                        ...
                                        <div class="carousel_desc">
                                            <div class="exc">
                                                ' . gt3_smarty_modifier_truncate($post_excerpt, 115) . '
                                            <!--a href="' . get_permalink($recent["ID"]) . '">'.((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("read_more_link") : __('Read more!','theme_localization')).'</a-->
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="item">
                                        ...
                                        <div class="carousel_body">
                                            ...
                                            <div class="carousel_desc">
                                                <div class="exc">' . gt3_smarty_modifier_truncate($post_excerpt, 115) . '</div>
                                            </div>
                                        </div>
                                    </div>
                                </li>
...
if (is_array($post_types)) {
    foreach ($post_types as $post_type) {
        if ($post_type !== "attachment" && $post_type !== "page") {
            $gt3_compileShortcodeUI .= "<option value='" . $post_type . "'>" . $post_type . "</option>";
        }
    }
}
...
#$gt3_shortcodesUI['feature_posts'] = array("name" => $shortcodeName, "handler" => $gt3_compileShortcodeUI);
