	...
	public function register_shortcode($shortcodeName) {
		function shortcode_social_share($atts, $content = null) {
			...
			<div class="share">
                ...
                <a target="_blank" class="share_pinterest share_icon ico_socialize type2 ico_socialize_pinterest" href="http://pinterest.com/pin/create/button/?url='.get_permalink().'&media='.gt3_get_theme_option("logo").'"></a>
...
#$gt3_shortcodesUI['social_share'] = array("name" => $shortcodeName, "handler" => $gt3_compileShortcodeUI);
