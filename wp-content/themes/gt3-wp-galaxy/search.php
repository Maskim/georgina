...
<div class="content_wrapper <?php echo ((isset($gt3_pagebuilder['settings']['show_breadcrumb']) && $gt3_pagebuilder['settings']['show_breadcrumb'] == "yes" && gt3_get_theme_option("show_breadcrumb") !== "off") ? 'withbreadcrumb' : 'withoutbreadcrumb') ?>">
    <div class="page_title_block">
        <div class="container">
            <?php if (function_exists('gt3_the_breadcrumb') && gt3_get_theme_option("show_breadcrumb") !== "off") {gt3_the_breadcrumb();} ?>
        </div>
    </div>
    <div class="container">
                        ...
                        <div class="contentarea">
                            ...
                            if ($foundSomething == false) {
                                ...
                                <div class="block404" style="width:100%; text-align: center;">
                                    <h1 class="title404"><?php echo ((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("translator_oops") : __('Oops!','theme_localization')); ?> <?php echo ((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("translator_header_404") : __('Not Found :(','theme_localization')); ?></h1>
                                    <div class="text404"><?php echo ((gt3_get_theme_option("translator_status") == "enable") ? gt3_get_text("translator_text_404") : __('Apologies, but we were unable to find what you were looking for.','theme_localization')); ?></div>
